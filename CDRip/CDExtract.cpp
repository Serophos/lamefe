...
BOOL CCDExtract::SetupTrackExtractParanoia( int nBeginSector, int nEndSector )
{
	...
	DebugPrintf("Leaving CCDExtract::SetupTrackExtractParanoia, return value %d", bReturn );
...
{
	DebugPrintf("Callback sector %08d code %d string %s \n", inpos/CB_CDDASECTORSIZE , function, (function>=-2&&function<=13?callback_strings[function+2]:"") );
