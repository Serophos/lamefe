...
public:
  ...
  size_t     Link(const tchar *fileInfo, flags_t = (flags_t) ID3TT_ALL);
  ...
  size_t     Link(const tchar *fileInfo, bool parseID3v1, bool parseLyrics3);
...
private:
  ...
  tchar*      __file_name;       // name of the file we are linked to
