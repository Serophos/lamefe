...
// Hydra : begin
char*      ID3_GetEncodedBy(const ID3_Tag*);
ID3_Frame* ID3_AddEncodedBy(ID3_Tag*, const char*, bool replace = false);
size_t     ID3_RemoveEncodedBy(ID3_Tag*);
// Hydra : end
...
char*      ID3_GetMCDI(const ID3_Tag*);
...
ID3_Frame* ID3_AddGenre(ID3_Tag*, char*, bool replace = false);
