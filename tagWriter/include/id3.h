...
extern "C"
{
  ...
  ID3_C_EXPORT size_t      CCONV   ID3Field_GetUNICODEItem     (const ID3Field *field, unicode_t *buffer, size_t maxChars, index_t itemNum);
  ...
  ID3_C_EXPORT size_t      CCONV   ID3Field_GetASCIIItem       (const ID3Field *field, char *buffer, size_t maxChars, index_t itemNum);
