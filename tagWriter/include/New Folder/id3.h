...
//lothar add CCONV
  ...
  ID3_C_EXPORT ID3Frame  *CCONV ID3Tag_GetFrameNum          (const ID3Tag *tag, index_t num);
  ...
  ID3_C_EXPORT size_t    CCONV  ID3Field_GetUNICODE         (const ID3Field *field, unicode_t *buffer, size_t maxChars, index_t itemNum);
  ...
  ID3_C_EXPORT size_t    CCONV  ID3Field_GetASCII           (const ID3Field *field, char *buffer, size_t maxChars, index_t itemNum);
